                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#features">Material</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#about">Exercícios Extras</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#facts">Vídeo Aulas</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#team">Aulas</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="#blog">Mensalidade</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
