        ...
        <div class="container">
                        ...
                        <table class="table table-bordered table-hover" style="background-color: white;">
                            ...
                            <tbody>
                                ...
                                <td><a class="more" href="quiz_vocab_jess.php"><img src="https://i.ibb.co/mRPQZjx/iconfinder-document03-1622833-121957.png" alt="quiz" height="25px" width="25px"></a>&nbsp;&nbsp;<a class="more" href="vide.php"><img src="https://i.ibb.co/v4bzb7F/botao-play.png" alt="video" height="25px" width="25px"></td>
                                </tr>
                                <tr>
                                <th>11/01</th>
